...
public class Assignment3 {
	...
	public static void main(String[] args){		
		...
		System.out.printf("Found %d words of length %d using (%s) without (%s).\n", wordCount, len, Arrays.toString(chars), Arrays.toString(illegals));
	...
	public static int iterate(char[] chars, String[] illegals, char[] build, int pos, int end){
		...
		for(int i = 0; i < chars.length; i++){
			...
			/* 
			 * Takes less time, but AC and CA as illegals are baked in
